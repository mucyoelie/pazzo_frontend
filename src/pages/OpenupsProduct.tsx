...
function OpenupsProduct() {
  const [products, setProducts] = useState<OpenupsType[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching Openups products:", err);
        setError(true);
      } finally {
        setLoading(false);
      }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Explore premium OpenUps power solutions for your business.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search OpenUps products..."
              value={searchTerm}
